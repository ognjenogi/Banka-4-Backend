    ...
    private void employeeSeeder() {
        List<Employee> employees = List.of(
                ...
                Employee.builder()
                        ...
                        .phone("3810633333333")
                        .address("321 Oak Dr")
                        .password(passwordEncoder.encode("securePass3"))
                        .username("samantham")
                ...
                Employee.builder()
                        ...
                        .phone("3810644444444")
                        .address("567 Pine Ln")
                        .password(passwordEncoder.encode("securePass4"))
                        .username("danielw")
                ...
                Employee.builder()
                        ...
                        .password(passwordEncoder.encode("securePass5"))
                        .username("jessicam")
                ...
                Employee.builder()
                        ...
                        .password(passwordEncoder.encode("securePass6"))
                        .username("michaelt")
                ...
                Employee.builder()
                        ...
                        .phone("3810677777777")
                        .address("789 Elm St")
                        .password(passwordEncoder.encode("securePass7"))
                        .username("laurah")
                ...
                Employee.builder()
                        ...
                        .password(passwordEncoder.encode("securePass8"))
                        .username("davidc")
                ...
                Employee.builder()
                        ...
                        .password(passwordEncoder.encode("securePass9"))
                        .username("emmal")
                ...
                Employee.builder()
                        ...
                        .password(passwordEncoder.encode("securePass10"))
                        .username("chrisw")
