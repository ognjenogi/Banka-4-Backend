...
public record ActuaryPayloadDto(
    ...
    @NotNull(message = "needsApproval is required")
    ...
    @NotNull(message = "Limit currency code is required")
    Currency.Code limitCurrencyCode,

    @Schema(
        description = "ID of the actuary (user)",
        example = "6d03b02b-b2d7-4de6-b2d5-9917f44d2f5a"
    )
    @NotNull(message = "Actuary ID is required")
    UUID actuaryId
