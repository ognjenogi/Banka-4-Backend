...
public record RegenerateAuthenticatorResponseDto(
        @Schema(description = "Newly generated TOTP otpauth, used for mobile clients to quickly setup TOTP with the given secret. QR code can be generated from this URI allowing the user to scan the QR code to create an authenticator.",
        ...
        @Schema(description = "Token secret used to setup a TOTP code in an authenticator app.",
