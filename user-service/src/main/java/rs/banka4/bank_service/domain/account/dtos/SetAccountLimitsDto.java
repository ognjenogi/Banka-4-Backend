...
public record SetAccountLimitsDto(
    @PositiveOrZero(message = "Daily limit must be positive or zero") BigDecimal daily,

    @PositiveOrZero(message = "Monthly limit must be positive or zero") BigDecimal monthly,
