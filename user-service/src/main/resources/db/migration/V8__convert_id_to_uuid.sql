UPDATE employees SET gender = 'MALE' WHERE gender = 'Male';
UPDATE employees SET gender = 'FEMALE' WHERE gender = 'Female';
UPDATE clients SET gender = 'MALE' WHERE gender = 'Male';
UPDATE clients SET gender = 'FEMALE' WHERE gender = 'Female';
