...
public class ClientControllerTests {
    ...
    void testGetMe() throws Exception {
        ...
        Mockito.when(clientService.getMe(any(String.class))).thenReturn(responseDto);
    ...
    void testGetClientById() throws Exception {
        ...
        ClientDto responseDto = ClientObjectMother.generateBasicClientDto();
        Mockito.when(clientService.getClientById(eq(id))).thenReturn(responseDto);
    ...
    void testGetClients() throws Exception {
        ...
        Mockito.when(clientService.getClients(any(), any(), any(), any(), any(), any(PageRequest.class))).thenReturn(ResponseEntity.ok(page));
    ...
    void testUpdateClient() throws Exception {
        ...
        Mockito.doNothing().when(clientService).updateClient(eq(id), any(UpdateClientDto.class));
