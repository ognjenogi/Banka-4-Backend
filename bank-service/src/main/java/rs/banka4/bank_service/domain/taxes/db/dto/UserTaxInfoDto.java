...
public record UserTaxInfoDto(
    @Schema(description = "Total tax paid this year", example = "860.00")
    BigDecimal paidTaxThisYear,
    @Schema(description = "Total unpaid tax for the current month", example = "72.50")
    BigDecimal unpaidTaxThisMonth,
    @Schema(description = "Currency of the amounts", example = "RSD")
    String currency
) {}
