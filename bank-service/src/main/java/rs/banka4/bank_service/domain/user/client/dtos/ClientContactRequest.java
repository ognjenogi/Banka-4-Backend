package rs.banka4.bank_service.domain.user.client.dtos;
...
public record ClientContactRequest(
    @Schema(
        description = "Client Account nickname",
    ...
    ) @NotBlank(message = "Account number for client is required") String accountNumber
) {
}
