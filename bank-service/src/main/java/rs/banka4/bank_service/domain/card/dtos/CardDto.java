...
public record CardDto(
    ...
    @Schema(
        ...
        example = "215351385938112"
    ) String accountNumber,
    @Schema(description = "Credit card owner") ClientDto client,
    @Schema(description = "Authorized user for business card") AuthorizedUserDto authorizedUserDto
) {
}
