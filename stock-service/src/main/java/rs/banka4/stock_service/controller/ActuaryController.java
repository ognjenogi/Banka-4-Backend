...
public class ActuaryController implements ActuaryApiDocumentation{
    ...
    public ResponseEntity<Void> update(@PathVariable UUID id,@RequestBody @Valid ActuaryPayloadDto dto) {
    ...
    public ResponseEntity<Void> updateLimit(@PathVariable UUID actuaryId, @RequestBody @Valid LimitPayload dto){
